...
!function(t,e){"use strict";"object"==typeof module&&"object"==typeof module.exports?module.exports=t.document?e(t,!0):function(t){if(!t.document)throw new Error("jTemplateLoader requires a window with a document");return e(t)}:e(t)}("undefined"!=typeof window?window:this,function(t,e){var o=function(t){return new o.prototype.init(t)};return o.fn=o.prototype={constructor:o,setOption:function(t){var e=this.option;for(var o in t)e[o]=t[o]},getEngine:function(){return t.Handlebars?"Handlebars":t.doT?"doT":t.jQuery&&t.jQuery.tmpl?"jQuery.tmpl":null},tmplToHtml:function(e,o){var r=this.engine,n="";switch(r){case"Handlebars":n=t.Handlebars.compile(e)(o);break;case"doT":n=t.doT.template(e,void 0,o);break;case"jQuery.tmpl":n=t.jQuery.tmpl(e,o);break;default:n=t.Handlebars.compile(e)(o)}return n},getTmplLoader:function(){return t.jQuery?"jQuery":t.fetch?"fetch":null},init:function(e){this.option={cacheProperty:"jstemplate",loadTimer:5e3},this.setOption(e);var o=this.option.cacheProperty;t[o]||(t[o]={});var r=this.getEngine();if(!r)throw Error("jTemplateLoader need templateEngine");var n=this.getTmplLoader();if(!n)throw Error("jTemplateLoader need AJAX loader");this.loader=n,this.engine=r,this.option.templates&&this.loadAllTemplate()},loadAllTemplate:function(){for(var t=this.option.templates,e=0,o=t.length;e<o;e++)this.loaderTmpl(t[e])},cacheTmpl:function(e,o){var r=this.option.cacheProperty,n=t[r];n[e]=o},loaderTmpl:function(e,o,r){var n=this,i=this.loader;"jQuery"==i&&t.jQuery.get(e,function(t,i,a){n.cacheTmpl(e,t),o&&r.call(n,n.tmplToHtml(t,o))},"text")},getCacheTmpl:function(e){var o=this.option.cacheProperty;return t[o]&&t[o][e]?t[o][e]:""},load:function(e,o,r){var n=this,i=this.option.cacheProperty;return""!=this.getCacheTmpl(e)?r.call(n,n.tmplToHtml(t[i][e],o)):void n.loaderTmpl(e,o,r)},html:function(t,e){var o=this.getCacheTmpl(t);return""==o?"":this.tmplToHtml(o,e)},checkCache:function(e){var o=this,r=this.option.cacheProperty,n=this.option.templates,i=this.option.loadTimer,a=500,l=0;if(!n)throw Error("template url is wrong");o.timer=setInterval(function(){for(var p=!0,c=0,h=n.length;c<h;c++)t[r][n[c]]||(p=!1);if(p&&(clearInterval(o.timer),e()),l+=a,a>i)throw clearInterval(o.timer),Error("template load timeout")},a)},ready:function(t){this.checkCache(t)}},o.prototype.init.prototype=o.prototype,"function"==typeof define&&define.amd&&define("jTemplateLoader",[],function(){return o}),e||(t.jTemplateLoader=t.jTem=o),o});